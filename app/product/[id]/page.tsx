...
const allProducts = {
  ...
  4002: {
    ...
    price: 155,
    description: "Lightweight women's hiking boots with superior comfort. Designed specifically for women's foot shape with enhanced arch support and a narrower heel for a secure fit.",
    images: ["/images/products/womans1.jpg"],
    colors: [
      { name: "Rose Gold", value: "rose" },
      { name: "Lavender", value: "lavender" },
      { name: "Sage Green", value: "sage" },
    ],
    sizes: [
      { size: "5", available: true },
      { size: "5.5", available: true },
    ...
    details: {
      style: "TTW-301",
      colorShown: "Rose Gold",
      material: "Lightweight mesh with synthetic overlays",
      sole: "Women's specific Vertex Trail outsole",
    },
    features: [
  ...
  4003: {
    ...
    price: 179,
    description: "Waterproof women's hiking boots for all weather conditions. Gore-Tex lining keeps feet dry while maintaining breathability for comfort on long hikes.",
    images: ["/images/products/womans2.jpg"],
    colors: [
      { name: "Coral", value: "coral" },
    ...
    details: {
      style: "SLG-302",
      colorShown: "Coral",
      material: "Gore-Tex waterproof membrane with nubuck leather",
  ...
  4004: {
    ...
    price: 139,
    description: "Fast and light women's trail running shoes. Built for speed on technical terrain with a responsive midsole and aggressive grip pattern.",
    images: ["/images/products/womans3.jpg"],
    colors: [
      { name: "Pink/Grey", value: "pink" },
      { name: "Turquoise/White", value: "turquoise" },
    ],
    sizes: [
      { size: "5", available: true },
      { size: "5.5", available: true },
    ...
    details: {
      style: "TBW-303",
      colorShown: "Pink/Grey",
      material: "Lightweight engineered mesh",
      sole: "Vertex SpeedTrail technology",
    },
    features: [
      "Lightweight trail running design",
  ...
  4005: {
    ...
    price: 169,
    description: "Technical women's boots for mountain hiking. Engineered for stability and support on challenging alpine terrain with advanced ankle protection.",
    images: ["/images/products/luna-rise.jpg"],
    colors: [
    ...
    details: {
      style: "ARE-304",
      colorShown: "Dusty Rose",
      material: "Technical synthetic with reinforced zones",
      sole: "Alpine grip technology",
    },
    features: [
      "Enhanced ankle support",
      "Alpine-ready construction",
      "Reinforced toe and heel",
      "Women's specific cushioning",
  ...
  4006: {
    ...
    price: 185,
    description: "Premium women's hiking boots with ankle support. Top-of-the-line materials and construction for serious female hikers who demand the best.",
    images: ["/images/products/sky-dancer.jpg"],
    colors: [
      { name: "Mauve", value: "mauve" },
      { name: "Pearl Grey", value: "pearl" },
    ...
    details: {
      ...
      sole: "Vertex ProGrip with carbon fiber shank",
    },
    features: [
      "Premium leather construction",
      "Carbon fiber shank",
  ...
  4007: {
    ...
    price: 149,
    description: "Versatile women's hiking shoes for day hikes. Perfect balance of comfort, support, and style for shorter adventures and everyday outdoor activities.",
    images: ["/images/products/pink.jpg"],
    colors: [
      { name: "Blush", value: "blush" },
      { name: "Lavender Grey", value: "lavender-grey" },
    ...
    details: {
      style: "RWW-306",
      colorShown: "Blush",
      material: "Synthetic mesh with suede overlays",
      sole: "All-terrain grip sole",
    },
    features: [
      "Low-profile design",
      "All-day comfort",
  ...
  4008: {
    ...
    price: 189,
    description: "Women's boots for extreme terrain and conditions. Built to handle the toughest trails with maximum protection and durability for adventurous women.",
    images: ["/images/products/dali.jpg"],
    colors: [
      { name: "Berry", value: "berry" },
      { name: "Stone Grey", value: "stone" },
    ...
    details: {
      style: "CQE-307",
      colorShown: "Berry",
      material: "Ballistic nylon with rubber reinforcements",
      sole: "Extreme terrain outsole with deep lugs",
    },
    features: [
      "Maximum protection design",
      "Deep lug outsole pattern",
